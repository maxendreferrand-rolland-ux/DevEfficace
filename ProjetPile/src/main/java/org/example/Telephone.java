 ...
 * création, saisie, affichage d'un numéro de téléphone, toString, et 
 * test d'égalité.
...
public class Telephone  {
    ...
    /**
     * Test d'égalité entre numéros de téléphone
     * @param aComparer numéro avec lequel comparer l'instance courante
     */
    @Override
    public boolean equals(Object aComparer) {
        if (! (aComparer instanceof Telephone)) {
            return false;
        }

        return numero.equals(((Telephone) aComparer).numero);
    }
